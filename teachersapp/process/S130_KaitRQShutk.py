...
def main(shitsmnID, int_seq, int_rqSeq):
    ...
    try:
        ...
        # クエリを定義
        sql = "select SHITSMN_ID, SEQ, RQSEQ, KAIT_USERID, KAIT_USERCOMMENT, RQYUKJKN, RQYUKKGN, MATCHINGFLG, CRTUSR, CRTDATE, UPDUSR,UPDDATE, DELFLG from T120_KAITREQUEST where SHITSMN_ID = %s and SEQ = %s and RQSEQ = %s and DELFLG = %s ;"
        # パラメータを定義
