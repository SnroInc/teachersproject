...
def main_bk(maxNo):
    ...
    for soup_backNumber in soup_backNumberArea:
        ...
        for soup_news in list_soup_news:
            ...
            newsURL = "https://p.nikkansports.com/goku-uma/news/" + \
                soup_news.get("href")
    ...
    newsVideo_kametani_url = soup.select(".movie__flex__video")[
        0].find_all("a")[0].get("href")
    newsVideo_kametani_imgSrc = soup.select(".movie__flex__video")[
        0].find_all("img")[0].get("src")
