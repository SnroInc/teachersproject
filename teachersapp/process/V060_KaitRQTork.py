    ...
    try:
        if request.method == 'POST':
            ...
            for int_seq in list_seq:
                ...
                datetime_rqYukKign = datetime.strptime(
                    str_rqYukKign, '%Y-%m-%d %H:%M:%S')
                json_S100 = S100_KaitRQTork.main(
                    shitsmnID, int_seq, kaitUserID, kaitUserComment, rqYukJikn, datetime_rqYukKign, "0")
                # 個々の値を取得
