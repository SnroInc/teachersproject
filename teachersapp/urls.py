...
urlpatterns = [
    ...
    path('shitsmnDetail/<str:shitsmnID>/',
         views.v050_ShitsmnDetailView, name='shitsmnDetail'),
    path('shitsmnDetail/<str:shitsmnID>/kaitRQTork/',
         views.v060_KaitRQTorkView, name='kaitRQTork'),
    path('shitsmnDetail/<str:shitsmnID>/kaitRQList/',
         views.v070_KaitRQListView, name='kaitRQList'),
    path('shitsmnDetail/<str:shitsmnID>/kaitRQDetail/<int:int_seq>/<int:int_rqSeq>/',
         views.v080_KaitRQDetailView, name='kaitRQDetail'),
